...
![Initial dashboard state](./output/playwright/crud-dashboard.png)
...
![Edit mode state](./output/playwright/crud-edit-mode.png)
...
![Updated record state](./output/playwright/crud-updated-record.png)
...
![Created record state](./output/playwright/crud-created-record.png)
